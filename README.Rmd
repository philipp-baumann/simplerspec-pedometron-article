...
In a nutshell, spectral data processing can be done in one pipeline. Resampling in this contexts refers to to creating a new a axis interval in spectra. Spectra are averaged because there are 3 replicate measurements for each soil sample. Preprocessing is done to reduce scattering and noise in spectra.
