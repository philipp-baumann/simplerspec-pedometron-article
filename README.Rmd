...
To reproduce the entire analysis in this hands-on, I would advise two main options:
...
To restore and reproduce this entire analysis and document, first clone this repository to your local computer. Then install renv and restore R packages based on the `renv.lock` file.
...
Option 2 is probably the easiest as it makes sure that all dependencies are met and the computational environment is the same.
